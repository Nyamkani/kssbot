...
#include "kssbot_hardware/diffbot_system.hpp"
...
hardware_interface::return_type kssbot_hardware::DiffBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
...
PLUGINLIB_EXPORT_CLASS(
  kssbot_hardware::DiffBotSystemHardware, hardware_interface::SystemInterface)
