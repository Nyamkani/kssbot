...
#ifndef KSSBOT_HARDWARE__VISIBILITY_CONTROL_H_
#define KSSBOT_HARDWARE__VISIBILITY_CONTROL_H_
...
#else
#define KSSBOT_HARDWARE_EXPORT __attribute__((visibility("default")))
#define KSSBOT_HARDWARE_IMPORT
#if __GNUC__ >= 4
#define KSSBOT_HARDWARE_PUBLIC __attribute__((visibility("default")))
#define KSSBOT_HARDWARE_LOCAL __attribute__((visibility("hidden")))
#else
#define ROS2_CONTROL_DEMO_HARDWARE_PUBLIC
#define ROS2_CONTROL_DEMO_HARDWARE_LOCAL
#endif
#define RKSSBOT_HARDWARE_PUBLIC_TYPE
#endif

#endif  // KSSBOT_HARDWARE__VISIBILITY_CONTROL_H_
